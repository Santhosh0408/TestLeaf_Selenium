...
public class LeafGround {
	public static void main(String[] args) throws InterruptedException {
		...
		ChromeDriver driver=new ChromeDriver();
	       ...
	       driver.findElement(By.xpath("//input[@id='j_idt88:name']")).sendKeys("Santhosh");
	     ...
	     if(enabled==false)
	       {
	        ...
	        WebElement f = driver.findElement(By.xpath("//input[@id='j_idt88:j_idt97']"));
		      ...
		      driver.findElement(By.xpath("//textarea[contains(@class,'ui-inputfield ui-inputtextarea')]")).sendKeys("I am Santhosh");
